...
public class Login extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // t= getSharedPreferences("data", Context.MODE_PRIVATE);
        ...
        t.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String shopkey=getIntent().getExtras().getString("shopkey");
...
//               String shopposition=getIntent().getExtras().getString("shopposition");
                if(s.getString("customerkey","")!=NULL)
                customerkey=s.getString("customerkey","");
                else
                ...
                in.putExtra("shopkey",shopkey);
                in.putExtra("name",name);
                Log.d("custKeyinlogintoex","%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%5"+customerkey);

                Log.d("shopKeyinlogintoex","%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%5"+shopkey);
